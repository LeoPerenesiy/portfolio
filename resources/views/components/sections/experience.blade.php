<section id="experience" class="relative w-full h-screen flex items-center justify-center overflow-hidden">
    <div class="exp-text-wrap relative z-10 w-4/5 max-w-3xl h-full overflow-y-auto text-white p-8">
        ...
        <div class="mb-6 exp-card">
            ...
            <p class="text-gray-300 card-date">06/2024 - present</p>
            ...
            <div class="tech-stack">
                ...
                <span class="tech-badge">Pure PHP</span>
                <span class="tech-badge">PosgreSQL</span>
                <span class="tech-badge">MySQL</span>
                <span class="tech-badge">Redis</span>
                <span class="tech-badge">Memcached</span>
                <span class="tech-badge">Docker</span>
                <span class="tech-badge">CI/CD</span>
                <span class="tech-badge">OPcache</span>
                <span class="tech-badge">Node.js</span>
                <span class="tech-badge">RabbitMQ</span>
                <span class="tech-badge">ElasticSearch / ManticoreSearch</span>
                <span class="tech-badge">PHP Unit / Codeception</span>
            </div>
        </div>

        <div class="mb-6 exp-card">
            <h3 class="text-2xl font-semibold">Corpsoft.io</h3>
            <p class="text-gray-300 card-date">08/2023 - 05/2024</p>
        ...
        <div class="mb-6 exp-card">
            <h3 class="text-2xl font-semibold">X-torus</h3>
            <p class="text-gray-300 card-date">07/2020 - 05/2023</p>
            ...
            <div class="tech-stack">
                <span class="tech-badge">Symfony</span>
                <span class="tech-badge">Laravel</span>
                <span class="tech-badge">Yii2</span>
                <span class="tech-badge">Redis</span>
                <span class="tech-badge">MySQL</span>
                <span class="tech-badge">Docker</span>
        ...
        <div class="mb-6 exp-card">
            <h3 class="text-2xl font-semibold">Aptech</h3>
            <p class="text-gray-300 card-date">03/2019 - 07/2020</p>
            <p class="text-gray-300 card-position">Full Stack Developer</p>
            <br />
            <br />
            <p class="text-gray-300 exp-p">
